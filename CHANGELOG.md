...
* docs: add Buy Me a Coffee sponsor link by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtag/pull/16
* chore: add GitHub Sponsors to FUNDING.yml by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtag/pull/19
* ci: standardize update-changelog workflow (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtag/pull/24
* ci: standardize dependabot config by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtag/pull/25
* build(deps): update jeffersongoncalves/laravel-gtag requirement from ^2.0 to ^3.0 in the composer-deps group by @dependabot[bot] in https://github.com/jeffersongoncalves/filament-gtag/pull/30
* feat(i18n): add translations (3.x) by @jeffersongoncalves in https://github.com/jeffersongoncalves/filament-gtag/pull/33

**Full Changelog**: https://github.com/jeffersongoncalves/filament-gtag/compare/3.2.0...3.3.0
